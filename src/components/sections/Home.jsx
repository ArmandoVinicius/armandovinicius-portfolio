  ...
  return (
    ...
    >
      <div className="text-center z-10 px-4">
        {/* Adicionar lib de letras aleatórias */}
        <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 bg-clip-text to-purple-600 text-transparent">
          Hi, I'm Armando Vinicius
        </h1>
